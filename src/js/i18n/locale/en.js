export const locale = {
  ...
  WELCOME: "Hi, you can call me Perry. I'm based in Edinburgh, Scotland. I provide in-person/online counselling & psychotherapy in English, Cantonese or Mandarin mainly for clients based in the UK and HK.",
  CORETITLE: "my core value",
  CORE1: "I do not heal. Healing occurs when we are “being” together. So I will be your companion. I see symptoms as psychic expressions of each individual with unique stories, experiences, personalities, behavioural patterns, complexes, psyches and souls. They encompass a symbolic meaning that guides our path of individuation.",
  ...
  JOURNEY1: "As a therapist/Jungian analyst-to-be, I have spent (and continue spending) years practising, not how to psychoanalyse people, but how to listen with a genuine heart, how to look into people’s eyes with an authentic soul, how to be a mundane human being in relation to the <em>Anima Mundi</em>.",
  ...
  APP2: "Having trained in psychodynamic and person-centred approaches as my foundation, my practice (and my being) has been profoundly influenced by Jungian and Deleuzo-Guattarian thought. I hold these theories to ground, while at the same time, moving beyond them — having no approach at all — allowing both of us  to move freely and creatively. Yes, this is a paradox.",
  APP2_1: "My (non-)approach is informed by various therapeutic frameworks and philosophies. Yet in the consulting room, I let them fall away and return to what is paramount and fundamental: our authentic soul-to-soul encounter.",
  ...
  APP17: "When things start making sense and becoming meaningful, psychic transformation will be experienced. What might potentially happen are having higher self-awareness, a fuller sense of self, bigger capacity to embrace the not-knowing in life and more ability to make better decisions without repeating unhealthy patterns.",
