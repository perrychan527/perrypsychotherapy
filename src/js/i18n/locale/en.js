export const locale = {
  ...
  CORE: "I see each person as an individual with unique stories, experiences, personalities, behavioural patterns, complexes, psyches, souls... which are all meaningful in some way. Something might not make sense at the moment, but I believe that the unconscious always moves ahead of us. I'm committed to creating a safe container for both of us to journey through depth, to “let it rain, let the wind blow, let the waters flow and the fire burn. Let each thing have its development, let becoming have its day” (Jung, The Red Book).",
  ...
  APPTITLE1: "Therapy",
  APP1: "Having trained in psychodynamic and person-centred approaches to counselling, I aim to create a confidential, empathic, and containing space between us, to explore what is happening in your life. I would describe therapeutic work as relational because, from my experience, I have found it fundamentally an authentic soul-to-soul encounter.",
