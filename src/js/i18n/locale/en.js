export const locale = {
  ...
  CORE: "I see each person as an individual with unique stories, experiences, personalities, behavioural patterns, complexes, psyches, souls... which are all meaningful in some way. Something might not make sense at the moment, but I believe that the unconscious always moves ahead of us. I'm committed to creating this safe space for us to journey through depth, to “let it rain, let the wind blow, let the waters flow and the fire burn. Let each thing have its development, let becoming have its day” (Jung, The Red Book).",
