					  ...
					  <v-card-text class="text-left">
						<v-container class="px-md-10 px-5 py-md-10 py-5">
						  <v-layout row wrap>
							...
							<v-flex xs12 sm12 md6>
							  <p class="subtitle-1 fade-up" style="transition-delay: 0.3s">{{ $t('londonJuly_eventIntro') }}
							  </p>
							</v-flex>
							<v-flex sm1 md1>
							</v-flex>
							<v-flex xs12 sm12 md5 pt-md-1 class="fade-up" style="transition-delay: 0.35s">
								<v-card
								class="mx-auto"
								max-width="280"
								>
						  ...
						  <v-layout row wrap>
							...
							<v-flex xs12 sm12 md6 pt-md-5 pt-sm-5>
							  ...
							  <p class="subtitle-1 fade-up" style="transition-delay: 0.25s">{{ $t('whatIsSDM_intro') }}
							  </p>
							</v-flex>
						  </v-layout>
						  <v-layout row wrap>
							...
							<v-flex xs12 sm12 md6 pt-md-2 pt-sm-5>
							  ...
							  <v-list-item-subtitle class="subtitle-1 text-wrap fade-up" style="transition-delay: 0.2s">{{ $t('londonJuly_Participate_c4') }}</v-list-item-subtitle>
							...
							<v-list-item-subtitle class="subtitle-1 fade-up" style="transition-delay: 0.35s">{{ $t('londonJuly_venueDistance') }}</v-list-item-subtitle>
							</v-flex>
							<v-flex sm1 md1>
							</v-flex>
